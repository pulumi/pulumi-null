...
namespace Pulumi.Null
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Null.version.txt");
    ...
    internal sealed class NullResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NullResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
